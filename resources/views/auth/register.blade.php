<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label value="{{ __('Nickname') }}"/>
                <x-jet-input class="block mt-1 w-full" type="text" name="nickname" :value="old('nickname')" required
                             autofocus autocomplete="name"/>
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input class="block mt-1 w-full" type="last_name"
                             :value="old('last_name')"
                             name="last_name"/>
            </div>
